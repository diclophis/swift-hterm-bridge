...
public func forkPseudoTeletypewriter(size:NSSize) -> (result:ForkResult, master:FileDescriptor) {
    var	amaster		=	0 as Int32
    var win:Winsize = Winsize(ws_row: 29, ws_col: 79, ws_xpixel: UInt16(size.width), ws_ypixel: UInt16(size.height))
